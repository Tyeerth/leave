...
//    @ResponseBody
//    public ResultEntity<Employee> getAdminInfo(HttpServletRequest request){
...
//    @ResponseBody
//   public ResultEntity<String> update(HttpServletRequest request,Employee admin) throws Exception {
//        Employee employee =(Employee) request.getSession().getAttribute("admin");
...
//            }else {
//                request.getSession().setAttribute(LoginConsts.STUDENT,admin);
...
//    public  ResultEntity<String> deleteEmployee(@PathVariable(value="id")String id, HttpServletResponse response) throws Exception {
